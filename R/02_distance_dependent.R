#' Distance-dependent Daniels et al. (1986) index
#' 
#' @export
#' 
...
#' Distance-dependent Hegyi (1974) index
#' 
#' @export
#' 
...
#' Distance-dependent Alemdag (1978) index
#' 
#' @export
#' 
...
#' Distance-dependent Matin & Ek (1984) index
#' 
#' @export
#' 
